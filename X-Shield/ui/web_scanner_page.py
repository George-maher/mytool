...
class WebScannerPage(QWidget):
    ...
    def setup_ui(self):
        ...
        # Title
        title_label = QLabel("Web Scanner")
    ...
    def setup_terminal_output(self, parent_layout):
        ...
        self.terminal.append('<span style="color: #2196F3;">[WEB SCANNER]</span> <span style="color: #ffffff;">Ready to scan web applications</span>')
